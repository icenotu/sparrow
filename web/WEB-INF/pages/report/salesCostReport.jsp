...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <!-- Datatables -->
    <script src="${proPath}/build/js/salesCostReportTables.js"></script>
    <!-- myForms -->
    <script src="${proPath}/build/js/salesCostReportForms.js"></script>
